...
This action can raise an alert comment. to the commit when its benchmark
results are worse than previous exceeding a specified threshold.

![alert comment](./images/alert-comment.png)
...
regression. Though `alert-comment-cc-users` input is not mandatory for
this, I recommend to set it to make sure you can notice the comment via GitHub notification. Please note
that this value must be quoted like `'@step-security'` because [`@` is an indicator in YAML syntax](https://yaml.org/spec/1.2/spec.html#id2772075).
...
Url to an optional different repository to store benchmark results (eg. `github.com/step-security/github-action-benchmark-results`)
...
[proj]: https://github.com/step-security/github-action-benchmark
[rust-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/rust.yml/badge.svg
[go-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/go.yml/badge.svg
[benchmarkjs-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/benchmarkjs.yml/badge.svg
[pytest-benchmark-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/pytest.yml/badge.svg
[cpp-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/cpp.yml/badge.svg
[catch2-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/catch2.yml/badge.svg
[julia-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/julia.yml/badge.svg
[java-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/java.yml/badge.svg
...
[rust-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Rust+Example%22
[go-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Go+Example%22
[benchmarkjs-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Benchmark.js+Example%22
[pytest-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Python+Example+with+pytest%22
[cpp-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22C%2B%2B+Example%22
[catch2-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Catch2+C%2B%2B+Example%22
[julia-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Julia+Example+with+BenchmarkTools.jl%22
[java-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22JMH+Example%22
[help-github-token]: https://docs.github.com/en/actions/security-guides/automatic-token-authentication
[minimal-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Example+for+minimal+setup%22
[commit-comment-workflow-example]: https://github.com/step-security/github-action-benchmark/actions?query=workflow%3A%22Example+for+alert+with+commit+comment%22
...
[benchmarkdotnet-badge]: https://github.com/step-security/github-action-benchmark/actions/workflows/benchmarkdotnet.yml/badge.svg
